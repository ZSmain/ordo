<script lang="ts">
	...
	let { userId, selectedDate, onOpenChange, onSessionCreated }: Props = $props();
	...
	let startDateValue = $state<CalendarDate | undefined>(getInitialSelectedDate());
	let startTime = $state('09:00');
	let endDateValue = $state<CalendarDate | undefined>(getInitialSelectedDate());
